...
export type MSTeamsConfig = {
  ...
  /**
   * Enable thread-based sessions for channels/groups.
   * When true, each thread gets its own session context.
   * Default: false (all channel messages share one session).
   */
